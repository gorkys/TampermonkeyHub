...
// @description:zh-CN   控制网页计时器速度
// @include      *
// @require             https://greasyfork.org/scripts/372672-everything-hook/code/Everything-Hook.js?version=659315
// @author              Cangshi|Gorkys
// @updateURL           https://github.com/gorkys/TampermonkeyHub/TimerHooker.user.js
// @match               http://*/*
...
~function (global) {
    ...
    var helper = function (eHookContext, timerContext, util) {
        return {
            applyUI: function () {
                var style = '._th-container ._th-item{margin-bottom:3px;position:relative;width:40px;height:40px;cursor:pointer;opacity:.3;background-color:#E9EBF1;border-radius:10px;text-align:center;line-height:40px;-webkit-transition:all .5s;-o-transition:all .5s;transition:all .5s;right:30px;margin-left:24px;font-size:16px;}._th-click-hover{position:relative;font-size:22px;-webkit-transition:all .5s;-o-transition:all .5s;transition:all .5s;height:50px;width:50px;cursor:pointer;opacity:.3;border-radius:10px;background-color:#E9EBF1;text-align:center;line-height:50px;right:-15px;margin-bottom:5px;}._th-container:hover{left:-10px}._th-container{font-size:12px;-webkit-transition:all .5s;-o-transition:all .5s;transition:all .5s;left:-40px;top:20%;position:fixed;-webkit-box-sizing:border-box;box-sizing:border-box;z-index:100000}._th-container ._th-item:hover{opacity:.8;background-color:#589DB9;color:aliceblue}._th-container:hover ._th-click-hover{opacity:.8}._th-container:hover ._th-item{opacity:.6;right:0}._th-container ._th-click-hover:hover{opacity:.8;background-color:#589DB9;color:aliceblue}._th_cover-all-show-times{position:fixed;top:0;right:0;width:100%;height:100%;z-index:99999;opacity:1;font-weight:900;font-size:30px;color:#4f4f4f;background-color:rgba(0,0,0,0.1)}._th_cover-all-show-times._th_hidden{z-index:-99999;opacity:0;-webkit-transition:1s all;-o-transition:1s all;transition:1s all}._th_cover-all-show-times ._th_times{width:80px;height:80px;border-radius:80px;background-color:rgb(99,162,245,.5);text-align:center;line-height:80px;position:absolute;top:50%;right:50%;margin-top:-40px;margin-right:-40px}';

                // 在页面左边添加一个半圆便于修改
                var html = '<div class="_th-container">\n' +
                    '    <div class="_th-click-hover" onclick="changTime()">✎</div>\n' +
                    '    <div class="_th-item _item-x4" title="快进" onclick="changTime(0,4)">▶</div>\n' +
                    '    <div class="_th-item _item-x-4" title="快退" onclick="changTime(0,-4)">◀</div>\n' +
                    '    <div class="_th-item _item-pip" onclick="changeVideoPIP()" title="画中画">❐</div>\n' +
                    '    <div class="_th-item _item-reset" title="恢复" onclick="changTime(0,0,false,true)">✖</div>\n' +
                    '</div>\n' +
            ...
            applyGlobalAction: function () {
                ...
                global.changeVideoPIP = function () {
                    // 判断是否存在画中画元素
                    if (!document.pictureInPictureElement) {
                        const getVideo = document.querySelectorAll('video')

                        if (!getVideo.length) alert('未找到Video元素,请确认页面中是否存在视频')

                        if (!Boolean(getVideo[0].id)) getVideo[0].id = 'video'

                        const video = document.getElementById(getVideo[0].id)
